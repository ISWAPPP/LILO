export const I18n = {
  ...
  translations: {
    uk: {
      ...
      'notes_title_placeholder': 'Заголовок (опціонально)...',
      ...
      'settings_font': 'Шрифт інтерфейсу',
      'settings_font_system': 'Системний за замовчуванням',
      'settings_font_georgia': 'Georgia (Елегантний із засічками)',
      'settings_font_garamond': 'Garamond (Книжковий класичний)',
      'settings_font_trebuchet': 'Trebuchet MS (Округлий сучасний)',
      'settings_font_consolas': 'Consolas (Технічний моно)',
      'settings_font_comic': 'Comic Sans MS (Грайливий/Нотатки)',
      'settings_font_impact': 'Impact (Жирний заголовочний)',
      'settings_font_verdana': 'Verdana (Широкий екранний)',
      'settings_font_courier': 'Courier New (Вінтажна друкарка)',
      ...
      'settings_toolbar_buttons': 'Кнопки панелі інструментів',
      'settings_passgen_label': 'Генератор паролів',
      'settings_passgen_desc': 'Показати або сховати віджет генератора паролів на вкладці Нотатки.',
      'settings_ui_elements_title': 'Елементи інтерфейсу',
      ...
      'settings_grain_title': 'М\'яка зернистість',
      'settings_grain_enable': 'Увімкнути ефект зернистості',
      'settings_grain_opacity': 'Інтенсивність',
      'settings_grain_contrast': 'Контраст',
      'settings_experimental_title': 'Експериментальні функції',
      'settings_experimental_notes': 'Експериментальні нотатки',
      'settings_experimental_notes_desc': 'Увімкнути перетягування нотаток мишкою та міні-наліпки з можливістю зміни ширини.',
      ...
      'notes_header_only': 'Тільки заголовок',
      'notes_title_edit': 'Редагувати',
      'notes_copy_tooltip': 'Копіювати',
      'notes_title_delete': 'Видалити',
      'notes_title_save': 'Зберегти',
      'notes_type': 'Тип',
      'notes_type_full': 'Широка',
      'notes_type_mini': 'Наліпка',
      'notes_width': 'Ширина',
    ...
    en: {
      ...
      'settings_grain_title': 'Soft Grain',
      'settings_grain_enable': 'Enable grain effect',
      'settings_grain_opacity': 'Intensity',
      'settings_grain_contrast': 'Contrast',
