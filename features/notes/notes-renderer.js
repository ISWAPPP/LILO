  ...
  noteItem(note) {
    ...
    return `
      <div class="note-item" data-id="${note.id}" style="${bgStyle}">
        <span class="note-text" title="Click to copy" style="${textStyle}">${escaped}</span>
        <div class="note-actions">
          <button class="note-move-up-btn" title="Вгору" style="${textStyle}">
          ...
          <button class="note-move-down-btn" title="Вниз" style="${textStyle}">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
          </button>
          <button class="note-edit-btn" title="Edit" style="${textStyle}">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
          </button>
          <button class="note-delete-btn" title="Delete" style="${textStyle}">
    ...
    return `
      <div class="note-item editing" data-id="${note.id}" style="${bgStyle}">
        <div style="display:flex; flex-direction:column; flex:1; gap:6px;">
          <textarea class="note-edit-input" placeholder="Note text..." rows="2" style="${textStyle}">${escaped}</textarea>
